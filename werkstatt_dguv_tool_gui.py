...
# Update the text of the button whilst working on the files
def on_button_click():
...
ticket_nummer_entry.place(x=145, y=125, width=130, height=25)

extract_scan_save_button = tk.Button(root, text = "Extract, Scan and Save", command = on_button_click)
extract_scan_save_button.place(x=145, y=170, width=130, height=25)

status_label = tk.Label(root, text = "")
status_label.place(x=145, y=210, width=130, height=25)
